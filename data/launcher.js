...
const AndroidLauncher = [
    {
        ...
        abbr: "FCL",
        download: "https://github.com/FCL-Team/FoldCraftLauncher/releases/download/1.1.7.3/FCL-release-1.1.7.3-all.apk",
        version: "1.1.7.3",
        url: "https://github.com/FCL-Team/FoldCraftLauncher"
    },
    {
        title: "PojavLauncher",
        download: "http://p.mcisee.top:6400/parser?url=https://share.feijipan.com/s/QEBPJVqh",
        version: "foxglo",
...
const WindowsLauncher = [
    ...
    },
    {
        ...
        abbr: "XMCL",
        download: "https://github.com/Voxelum/x-minecraft-launcher/releases/download/v0.45.1/xmcl-0.45.1-win32-x64.zip",
        version: "0.45.1",
    ...
    },
    {
        ...
        abbr: "PCL1",
        download: "http://p.mcisee.top:6400/parser?url=https://share.feijipan.com/s/kwAt8rhZ",
        version: "1.0.9",
...
const macOSLauncher = [
    ...
    },
    {
        ...
        url: "https://github.com/HMCL-dev/HMCL",
        dev: {
            download: "https://github.com/HMCL-dev/HMCL/releases/download/v3.5.8.251/HMCL-3.5.8.251.jar",
            version: "3.5.8.251"
        }
    },
    {
    ...
    },
    {
        title: "X Minecraft Launcher",
        abbr: "XMCL",
        download: "https://github.com/Voxelum/x-minecraft-launcher/releases/download/v0.45.1/xmcl-0.45.1.dmg",
        version: "0.45.1",
        url: "https://github.com/Voxelum/x-minecraft-launcher"
    },
    {
...
const LinuxLauncher = [
    {
        ...
        url: "https://github.com/HMCL-dev/HMCL",
        dev: {
            download: "https://github.com/HMCL-dev/HMCL/releases/download/v3.5.8.251/HMCL-3.5.8.251.sh",
            version: "3.5.8.251"
        }
    },
    {
    ...
    },
    {
        title: "X Minecraft Launcher",
        abbr: "XMCL",
        download: "https://github.com/Voxelum/x-minecraft-launcher/releases/download/v0.45.1/xmcl-0.45.1-arm64.deb",
        version: "0.45.1",
        url: "https://github.com/voxelum/x-minecraft-launcher"
    },
    {
