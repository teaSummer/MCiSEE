...
无类别
  ...
  网易我的世界官网：
    https://mc.163.com
  Inner Core基岩版模组引擎：
    https://icmods.mineprogramming.org
  MCPEDL资源下载站：
    https://mcpedl.com
  地图查询网站：
...
#   https://minewiki.net
  ...
  正版玩家信息查询：
    https://mcuuid.net
  服务器列表(大陆)Ⅰ：
    https://www.mclists.cn
  服务器列表(大陆)Ⅱ：
    https://www.fwqlist.com
  找服网：
    https://www.fansmc.com
  低多边形3D模型编辑器：
    https://www.blockbench.net
  装饰性头颅：
    https://www.minecraft-heads.com
  基岩版文档：
    https://bedrock.dev
  基岩版维基百科：
...
国际基岩版版本库
  ...
  甘泉版本库 (原像素科技):
    https://mcbbk.blmcpia.com
  mcfa版本库 (@zihao_il):
    https://bbk.endyun.ltd/main
  mcfw版本库 (MCAppx):
    https://www.mcappx.com
  mcarc版本库 (@Hottampist):
    https://mcarc.github.io
#  -- 以下需要魔法才能访问 --
#  互联网档案馆上的alpha版本库:
#    https://archive.org/details/MCPEAlpha

非简体中文 (与无类别相关)
  指令工具(台湾)：
    https://new.kukuo.tw/tools/
  最好的服务器(国际)：
...
快查网站 (可供快速查询的网站)
  ...
  MC百科：
    https://mcmod.cn
  基岩版ID表：
    https://ca.projectxero.top/idlist/#release-vanilla/global/
  Java版ID表：
    http://mcid.lingningyu.cn
  基岩版开发Wiki：
    https://wiki.mcbe-dev.net
  插件百科：
    https://mineplugin.org

开源网站 (有助于开发者)
  Midi音乐转换为播放音乐的bdump v3结构文件：
    https://dislink.github.io/midi2bdx/
  Midi音乐转换为播放音乐的mcpack行为包：
    https://dislink.github.io/midi2mcfunction/
  Midi音乐转换为可视化音符瀑布流mcpack行为包：
    https://dislink.github.io/midi2tiles/
  各种图片转换为放置方块的mcpack行为包：
    https://dislink.github.io/img2mcfunction/
  文字转换为粒子画的mcpack行为包：
    https://dislink.github.io/text2mcfunction/
  mcfunction文件转换为bdump v3结构文件：
...
友情链接[open]
  FreeDayO：
    https://butian103.github.io/FreeDayO-NetWork/
  FDS：
    https://fds.moe
  饼盒：
    https://mc.xzwmc.com
...
其它论坛
  香港社区：
    https://www.minecraft-hk.com
  台湾论坛：
    https://forum.gamer.com.tw/A.php?bsn=18673
  基岩版台湾中文网：
    https://forum.mcpe.tw
  韩国论坛：
    https://www.koreaminecraft.net
  日本论坛：
